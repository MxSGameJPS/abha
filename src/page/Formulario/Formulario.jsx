      ...
      >
        <fieldset className={styles.secao}>
          ...
          <div className={styles.radioGroup}>
            ...
            <label>
              <input type="radio" name="choro_pixar" value="2" /> 2 - Só um leve
              brilho nos olhos, nada demais
            </label>
            <label>
            ...
            <label>
              <input type="radio" name="choro_pixar" value="5" /> 5 - "A poeira
              nos meus olhos" já não cola mais
            </label>
          </div>
        </fieldset>
        ...
        <fieldset className={styles.secao}>
          ...
          <label>
            Cenário: Você está em um churrasco de família. Seu tio faz uma piada
            sem graça e levemente ofensiva. Sua reação:
          </label>
          <div className={styles.radioGroup}>
            <label>
              <input
            ...
            <label>
              ...
              Mudo de assunto rapidamente, oferecendo um pedaço de pão de alho.
            </label>
            <label>
              <input
                type="radio"
              ...
              />{" "}
              Lanço um olhar de reprovação sutil, mas elegante, enquanto ajusto
        ...
        <fieldset className={styles.secao}>
          ...
          <label>
            Um amigo te convida para "tomar uma". Ao chegar no bar, ele pede uma
            cerveja e você está com vontade de tomar um Aperol Spritz. Você:
          </label>
          <div className={styles.radioGroup}>
            <label>
              <input type="radio" name="aperol" value="Pede cerveja" required />{" "}
              Pede a cerveja. Afinal, quem toma Aperol às seis da tarde?
            </label>
            <label>
              <input type="radio" name="aperol" value="Pede Aperol com piada" />{" "}
        ...
        <fieldset className={styles.secao}>
          ...
          <div className={styles.checkboxGroup}>
            ...
            <label>
              ...
              abrir um pote de azeitonas, mas em admitir que você prefere um bom
              Pinot Noir.
            </label>
          </div>
          <label>
